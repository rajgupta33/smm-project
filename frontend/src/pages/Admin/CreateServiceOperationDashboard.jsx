...
const ServiceOperationsDashboard = ({ setPageMode }) => {
  return (
    <>
    <ResponsiveNavbar/>
    <div className="min-h-screen bg-surface-sunken text-ink p-4 sm:p-6 lg:p-8 flex flex-col items-center justify-center">
      ...
      <div className="flex flex-col sm:flex-row gap-8 w-full max-w-sm sm:max-w-xl">
        <button
          ...
          className="inline-flex items-center px-10 py-5 border border-transparent text-lg sm:text-xl font-extrabold rounded-3xl shadow-card hover:shadow-lift
                     text-white bg-gradient-to-br from-blue-700 to-blue-900 hover:from-blue-800 hover:to-blue-950
                     focus:outline-none focus:ring-4 focus:ring-offset-2 focus:ring-blue-500 focus:ring-offset-surface
                     transition-all duration-300 w-full justify-center transform hover:scale-105 active:scale-95
                     group relative overflow-hidden"
        >
          <span className="absolute inset-0 bg-surface opacity-10 group-hover:opacity-0 transition-opacity"></span>
        ...
        <button
          ...
          className="inline-flex items-center px-10 py-5 border border-transparent text-lg sm:text-xl font-extrabold rounded-3xl shadow-card hover:shadow-lift
                     ...
                     focus:outline-none focus:ring-4 focus:ring-offset-2 focus:ring-green-500 focus:ring-offset-surface
                     transition-all duration-300 w-full justify-center transform hover:scale-105 active:scale-95
                     group relative overflow-hidden"
        >
          <span className="absolute inset-0 bg-surface opacity-10 group-hover:opacity-0 transition-opacity"></span>
