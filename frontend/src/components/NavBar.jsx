            ...
            {auth.user && (
              <li>
                <button
                  ...
                  className="flex items-center text-white hover:text-purple-400 transition-colors duration-300 disabled:opacity-50"
                >
            ...
            {auth.user && (
              <li>
                <button
                  onClick={handleLogout}
                  disabled={isLoggingOut}
                  className="flex items-center px-4 py-2 text-white hover:bg-purple-900 rounded-lg transition-colors w-full justify-start disabled:opacity-50"
                >
                  {getIconComponent('LogOutIcon')}
                  <span>{isLoggingOut ? 'Logging out...' : 'Logout'}</span>
                </button>
